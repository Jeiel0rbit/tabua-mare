...
export default function TideChart({ tideData, monthYear }: TideChartProps) {
  ...
  if (!chartData.length) {
    return <p className="text-center text-muted-foreground">Não há dados suficientes para gerar o gráfico.</p>;
  }
      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Line
            ...
            strokeWidth={2}
            dot={(props) => {
              const { cx, cy, stroke, payload } = props as any; // Cast to any to access payload easily
